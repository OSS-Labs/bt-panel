var lan = {
	"get":function(key,args){
		var msgs = {
			...
			"del":"删除[{1}]",
			"del_all_task":"共选择了[{1}]个任务，删除后将无法恢复，继续吗？",
			...
			"service_confirm":"确定要{1}{2}服务吗？",
			"service_the":"正在{1}{2}服务，请稍候...",
			"service_ok":"{1}服务已{2}！",
			"service_err":"{1}服务{2}失败！",
			"recycle_bin_confirm":"确实要把此文件[{1}]放入回收站吗？",
			"recycle_bin_confirm_dir":"确实要把此目录[{1}]放入回收站吗？",
			"del_all_ftp":"共选择了[{1}]个FTP，删除后将无法恢复，继续吗？",
			"del_all_ftp_ok":"成功删除{1}个FTP帐户！",
			"del_all_database":"共选择了[{1}]个数据库，删除后将无法恢复，继续吗？",
			"del_all_database_ok":"成功删除[{1}]个数据库！",
			"config_edit_ps":"此处为{1}主配置文件，若您不了解配置规则，请勿随意修改！",
			"install_confirm":"确定要安装{1}-{2}吗？",
			"del_all_site":"共选择了[{1}]个站点，删除后将无法恢复，继续吗？",
			"del_all_site_ok":"成功删除[{1}]个站点！",
			"ssl_enable":"已启用[{1}]证书，如需关闭，请点击\"关闭SSL\"按钮。"
		}
	...
	"index":{
		...
		"update_log":"版本更新",
		"reboot_title":"重启服务器",
		"reboot_warning":"若您的服务器是一个容器，请取消该操作。",
	...
	"config":{
		"close_panel_msg":"关闭面板会导致您无法访问面板，继续吗？",
		"close_panel_title":"关闭面板",
		"config_save":"正在保存配置...",
		"config_sync":"正在同步时间...",
		"config_user_binding":"绑定宝塔帐号",
		"config_user_edit":"修改绑定官网账号",
		"binding":"绑定",
		"token_get":"正在获取密钥...",
		"user_bt":"官网账号",
		"pass_bt":"官网密码",
		"binding_un_msg":"确定要解除绑定官网帐号吗？",
		"binding_un_title":"解除绑定",
		"binding_un":"解绑",
		"ssl_close_msg":"关闭SSL后，必需使用http协议访问面板，继续吗?",
		"ssl_open_ps":"如果你不了解此功能，请谨慎操作！",
	...
	"firewall":{
		...
		"ssh_port_msg":"更改远程端口时，将会注消所有已登录帐户，继续吗？",
		"ssh_port_title":"远程端口",
		"ssh_off_msg":"停用SSH服务的同时也将注销所有已登录用户，继续吗？",
		"ssh_on_msg":"确定启用SSH服务吗？",
		"ping_msg":"禁PING后不影响服务器正常使用，但无法Ping通服务器，继续吗？",
		"ping_un_msg":"解除禁PING状态可能会被黑客发现您的服务器，继续吗？",
		"ping_title":"是否禁Ping",
		"ping":"已禁Ping",
		"ping_un":"已解除禁Ping",
		"ping_err":"连接服务器失败",
	...
	"upload":{
		...
		"up_speed":"上传进度：",
		"up_err":"上传错误！",
		"ie_err":"不支持IE 6/7/8浏览器，请更换浏览器再上传！"
	},
	...
	"bt":{
		...
		"install_type":"安装方式",
		"install_rpm":"极速安装",
		"install_rpm_title":"安装时间极快（5~10分钟），性能与稳定性略低于编译安装",
		"install_src":"编译安装",
		...
		"panel_ps_2":"面板备注不可重复！",
		"panel_ps_3":"<font style='color:red'>开启广告拦截会导致无法快捷登录。</font>",
		"task_time":"时间",
		"task_name":"名称",
		"task_msg_title":"消息提醒",
		"task_title":"消息盒子",
	...
	"files":{
		...
		"recycle_bin_ps":"关闭回收站，删除的文件无法恢复！",
		...
		"recycle_bin_re_msg":"若原位置已有同名文件或目录，将被覆盖，继续吗？",
	...
	"ftp":{
		...
		"stop_confirm":"确定要停止{1}的FTP吗？",
		"stop_title":"FTP帐户",
		"pass_title":"修改FTP用户密码",
		"pass_user":"用户名",
		"pass_new":"新密码",
		"pass_confirm":"确定要修改该FTP帐户密码吗？",
		"port_title":"修改FTP端口"
	},
	...
	"database":{
		...
		"input_ps1":"仅支持 sql、zip（tar.gz|gz|tgz）",
		"input_ps2":"zip、tar.gz 压缩包结构：test.zip 或 test.tar.gz 压缩包内，必需包含 test.sql",
		"input_ps3":"若文件过大，您还可以使用SFTP工具，将数据库文件上传到 /www/backup/database",
		"input_up_type":"请上传 sql、zip 或 tar.gz 压缩包",
	...
	"soft":{
		...
		"mvc_ps":"MVC 架构的程序需要开启，如：typecho",
		"the_install":"正在安装...",
		"the_uninstall":"正在卸载...",
		"install_the":"安装中...",
		"sleep_install":"等待安装...",
		...
		"php_ext_uninstall_confirm":"确定要安装{1}吗？",
		...
		"setup":"设置",
		"apache22":"当前为php-fpm模式，将不被Apache2.2支持，请重新安装此PHP版本!",
		"apache24":"当前为php5_module模式，将不被Nginx/Apache2.4支持，请重新安装此PHP版本!",
		"apache22_err":"Apache2.2不支持多PHP版本共存，请先卸载已安装PHP版本，再安装此版本！",
		"mysql_f":"安装新的MySQL会覆盖数据库数据，请先备份数据库！",
		"mysql_d":"为了安全考虑，请先到[数据库]管理备份数据库，并删除所有数据库！",
		...
		"waf_title":"过滤器",
		"web_service":"Web服务",
		"waf_not":"当前Nginx版本不支持waf模块，请安装Nginx1.12，重装Nginx不会丢失已有的网站配置！",
		"waf_edit":"编辑规则",
		"waf_up":"上传限制",
		"waf_input1":"URL过滤",
		"waf_input2":"Cookie过滤",
		...
		"waf_cc_err":"CC防御配置值超出可用值（频率 1-3000 | 周期 1-1800）",
		"php_version":"PHP版本",
		"save_path":"存储位置",
		"service":"服务",
		"safe":"安全设置",
		...
		"mysql_port_title":"修改数据库端口可能会导致您的站点无法连接数据库，继续吗？",
		"select_version":"选择版本",
		"version_to":"切换",
		"pma_port":"访问端口",
		...
		"qiniu_th3":"大小",
		"qiniu_th4":"更新时间",
		"mysql_del_err":"为安全考虑，请先到[数据库]管理备份数据库，并删除所有数据库！",
		...
		"mysql_set_conn":"连接数",
		"mysql_set_err":"内存分配过高！<p style='color:red;'>物理内存：{1}MB<br>最大使用内存：{2}MB<br>可能造成的后果：导致数据库不稳定，甚至无法启动MySQLd服务！</p>",
		...
		"mysql_status_ps1":"若值过大，增加 max_connections",
		"mysql_status_ps2":"若过低，增加 thread_cache_size",
		"mysql_status_ps3":"若过低，增加 key_buffer_size",
		"mysql_status_ps4":"若过低，增加 innodb_buffer_pool_size",
		"mysql_status_ps5":"若过低，增加 query_cache_size",
		"mysql_status_ps6":"若过大，尝试增加 tmp_table_size",
		"mysql_status_ps7":"若过大，增加 table_cache_size",
		"mysql_status_ps8":"若不为0 ，请检查数据表的索引是否合理",
		"mysql_status_ps9":"若不为0 ，请检查数据表的索引是否合理",
		"mysql_status_ps10":"若值过大，增加 sort_buffer_size",
	...
	"site":{
		...
		"run_dir":"运行目录",
		"site_help_1":"部分程序需要指定二级目录作为运行目录，如 ThinkPHP5、Laravel",
		"site_help_2":"选择您的运行目录，点保存即可",
		"default_doc_help":"默认文档，每行一个，优先级由上至下",
		"site_stop_txt":"站点停用后将无法访问，继续吗？",
		"site_start_txt":"即将启动站点，继续吗？",
		...
		"domain_del_confirm":"确定要从站点中删除这个域名吗？",
		"webback_del_confirm":"确定要删除备份包吗？",
		"del_bak_file":"删除备份文件",
		"filename":"文件名称",
		"filesize":"文件大小",
		"backuptime":"打包时间",
		...
		"subdirectories":"子目录",
		"url_rewrite_alter":"确定要为这个子目录创建独立的伪静态规则吗？",
		"rule_cov_tool":"规则转换工具",
		"a_c_n":"Apache转Nginx",
		"save_as_template":"另存为模板",
		"url_rw_help_1":"请选择您的应用，若设置伪静态后，网站无法正常访问，请尝试设置回 default",
		"url_rw_help_2":"您可以对伪静态规则进行修改，修改完后保存即可。",
		"config_url":"配置伪静态规则",
		"d_s_empty":"域名和子目录名称不能为空！",
		"s_bin_del":"确定要删除这个子目录绑定吗？",
		"proxy_url":"目标URL",
		...
		"to_con":"替换为,可留空",
		"proxy_enable":"启用反向代理",
		"proxy_help_1":"目标URL必需是可以访问的，否则将直接502错误",
		...
		"ssl_crt":"证书（PEM格式）",
		"ssl_close":"关闭SSL",
		"bt_bind_no":"未绑定官网账号，请注册绑定，绑定官网账号（非论坛账号）可实现一键部署SSL",
		"bt_user":"官网账号",
		"login":"登录",
		"bt_reg":"注册官网账号",
		"bt_ssl_help_1":"宝塔SSL证书为亚洲诚信证书，需要实名认证才能申请使用",
		"bt_ssl_help_2":"已有官网账号请登录绑定",
		"bt_ssl_help_3":"宝塔SSL申请的是TrustAsia DV SSL CA - G5证书，原价：1900元/1年，宝塔用户免费！",
		...
		"tomcat_help2":"若您需要其它版本，请到 软件管理 > 所有软件 中切换；",
