...
function updatapro(){
	var payhtml = '<div class="libPay" style="padding:15px 30px 30px 30px">\
				...
				<p style="position:absolute;bottom:17px;left:0;width:100%;text-align:center;color:red">注：如需购买多台永久授权，请登录官网购买。<a class="btlink" href="https://www.bt.cn/download/linuxpro.html#price" target="_blank">去官网</a></p>\
			</div>';
	layer.open({
			type: 1,
